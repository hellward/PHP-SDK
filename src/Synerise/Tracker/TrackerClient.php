<?php
namespace Synerise\Tracker;

use Synerise\SyneriseAbstractHttpClient;
use GuzzleHttp\Collection;
use Synerise\Tracker\Producers\Client;
use Synerise\Tracker\Producers\Event;
use GuzzleHttp\Pool;
use GuzzleHttp\Ring\Client\MockHandler;
use GuzzleHttp\Subscriber\History;
use Synerise\Consumer\ForkCurlHandler;

class TrackerClient extends SyneriseAbstractHttpClient
{

    /**
     * An instance of the Client class (used to create/update client profiles)
     * @var Tracker\Producers\Client
     */
    public $client;
    ...
    /**
     * Instantiates a new TrackerClient instance.
     * @param array $config
     */
